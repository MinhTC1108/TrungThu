...
const fallbackWishImage = "./assets/1.jpg";

const wishList = [
  {
    text: "Chúc vk iu có một ngày trung thu vui vẻ, đầy hạnh phúc!",
    img: "./assets/1.jpg",
  },
  {
    text: "Thương vk iu lắm á, vk iu dethw nhất trên đờiiiiii.",
    img: "./assets/2.png",
  },
  {
    text: "Nhân dịp trung thu, chúc vk iu mau hết đau và mình có thể bên nhau mãi mãi nheeee.",
    img: "./assets/3.png",
  },
  {
    text: "Chúc vk luôn giữ được tâm hồn trong trẻo, yêu đời như ánh trăng rằm.",
    img: "./assets/1.jpg",
  },
  {
    text: "Trung thu vui vẻ nha em bé oiii!",
    img: "./assets/2.png",
  },
  {
    text: "Chúc riêng vk một đêm trăng thật lãng mạn và ngọt ngào.",
    img: "./assets/3.png",
  },
  {
    text: "Thương em lắm áaaaaaa",
    img: "./assets/1.jpg",
  },
];

function resolveWishImage(src) {
  return src && src.trim() ? src : fallbackWishImage;
}
...
function onPointerUp(event) {
  ...
  if (intersects.length > 0) {
    ...
    wishImage.src = resolveWishImage(selectedLantern.userData.imgUrl);
...
function toggleAudio(forceState) {
  if (forceState === true || (!forceState && isPlaying === false)) {
    bgm
      .play()
      .then(() => {
        isPlaying = true;
